#!/usr/bin/env python3
"""Whisper Market v0.1. SQLite transactions own game facts; the host model owns narration."""
...
def main():
    parser = argparse.ArgumentParser(description="窃语黑市 · 第一章。由 WorkBuddy 操作的本地规则与存档工具。")
